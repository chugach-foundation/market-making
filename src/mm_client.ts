...
export class CypherMMClient {
    ...
    makeMintInstruction(price: number, size: number, decimals: number, baseDecimals: number, quoteDecimals: number): TransactionInstruction {
        return this.mintctr.makeMintCAssetsInstr(this.cAssetMint, size, decimals, price, baseDecimals, quoteDecimals);
    }
